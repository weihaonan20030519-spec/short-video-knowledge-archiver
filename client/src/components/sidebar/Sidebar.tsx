...
export function Sidebar(props: SidebarProps) {
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col gap-5 overflow-hidden rounded-[28px] border border-slate-800 bg-slate-950/95 px-4 py-5 text-white shadow-panel">
      <div>
